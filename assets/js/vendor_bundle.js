        ...
        */  maps: [],
        ...
        map_openstreet: function(_this) {
            ...
            var _mapID              = _this.attr('id')                  || '',
                ...
                map_popup_autoclose = _this.data('map-popup-autoclose') || '',
                __zoom__            = _this.data('map-zoom')            || 9,
                map                 = [];

            if(!map_popup_autoclose || map_popup_autoclose != 'true')
                map_popup_autoclose = false;
            else map_popup_autoclose = true;
            ...
            for(var i=0; i < map_json.length; ++i) {
                ...
                /* add popup */
                if(__popup__ != '')
                    __map[_rand].bindPopup(L.popup({maxWidth:300, autoClose:map_popup_autoclose, autoPan:false}).setContent("<div class='small'>"+__popup__+"</div>")).openPopup();
...
$.SOW.config.autoinit['fullcalendar'] = ['$.SOW.vendor.fullcalendar.init','.fullcalendar', {plugins:["interaction","dayGrid","timeGrid","list","bootstrap","googleCalendar"],editable:true,eventLimit:true,locale:"en",themeSystem:"bootstrap",defaultView:"dayGridMonth",defaultDate:"2024-11-13T11:21:23.997Z",timeZone:"UTC",header:{left:"prev,next today, addEventButton",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay,listWeek"},buttonText:{today:"today",month:"month",week:"week",day:"day",list:"list"},eventTimeFormat:{hour:"numeric",minute:"2-digit",meridiem:"short"}},true];
